        ...
        <div className="container text-white">
            ...
            <div className="col-md-6">
              ...
              <div className="align-content-center d-flex gap-3 justify-content-end">
                {socialLinks.map((link, index: number) => {
                  return (
                    <a key={index} role="button" href={link.link}>
                      <i
                        className={cx(
                          "bi bi-github text-white fs-3",
                          link.iconClassName,
                        )}
                      ></i>
                    </a>
          ...
          <div className="row">
            <div className="col-md-12 pb-4">
              <div
                className={cx(
                  "text-center font-family-montserrat",
                  ["xs", "sm"].includes(currentBreakpoint) ? "fs-6" : "",
                )}
              >
                Made with <span className="text-danger">&#10084;</span> by Sutej
                Pal
              </div>
            </div>
          </div>
